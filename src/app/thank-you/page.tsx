          ...
          <div className="lg:col-start-2">
            ...
            {order._isPaid ? (
              <p className="mt-2 text-base text-muted-foreground">
                ...
                todownload below. We&apos;ve send your receipt and order details
                to{" "}
            ...
            <div className="mt-16 text-sm font-medium">
              ...
              <div className="space-y-6 border-t border-gray-200 pt-6 text-sm font-medium text-muted-foreground">
                <div className="flex justify-between">
                  <p>Subtotal</p>
                  <p className="text-gray-900">{formatePrice(orderTotal)}</p>
                </div>
                ...
                <div className="flex items-center justify-between border-t bg-gray-200 pt-6 text-gray-900">
                  <p className="text-base">Total</p>
                  <p className="text-base">{formatePrice(orderTotal + 1)}</p>
                </div>
              </div>
