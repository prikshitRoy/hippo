...
//! A function to know which product belongs to which user.
...
//! Everyone will able to (read,update,delete) only there products and admin can (read,update,delete) everyone products
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            updated = __assign(__assign({}, data), { stripeId: createdProduct.id, prideId: createdProduct.default_price });
                        ...
                        case 2:
                            ...
                            return [4 /*yield*/, stripe_1.stripe.products.update(data.stripeId, {
                                    name: data.name,
                                    default_price: data.prideId,
                                })];
                        case 3:
                            UpdatedProduct = _a.sent();
                            updated = __assign(__assign({}, data), { stripeId: UpdatedProduct.id, prideId: UpdatedProduct.default_price });
                            return [2 /*return*/, updated];
